...
<div class="nav" style="height: 500px">
    <ul>
        ...
        <li><a href="http://192.168.2.206/" class="btn btn-success"><i class="far fa-newspaper faa-tada animated"style="font-size:20px;"></i>  NPTEL Courses</a>
        <li><a href="http://jecc.ac.in/library/libusers/login" class="btn btn-warning"><i class="fas fa-lock faa-flash animated" style="font-size:20px;"></i> Library Log In</a>
        <li><a href="admin/login.php" class="btn btn-info"><i class="fas fa-user faa-passing animated"style="font-size:20px;"></i> Admin Log In</a>
    </ul>
</div>
